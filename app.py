...
def call_gemini_to_extract_tasks(api_key: str, syllabus_text: str):
...
"""
        ...
        # Guarantee JSON response using config
    ...
    if uploaded_file is not None:
        ...
        if analyze_btn:
            if not api_key_input:
                ...
                if pdf_text:
                    with st.spinner("2. Gemini AI 분석 중 (일정 및 마감 기한 추출)..."):
                        extracted_tasks = call_gemini_to_extract_tasks(api_key_input, pdf_text)
